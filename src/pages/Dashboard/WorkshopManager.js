...
const WorkshopManager = () => {
    ...
    const { user } = useAuth();
    const { id } = useParams(); // Get workshop ID for edit mode
    ...
    // Load existing workshop data in edit mode
    useEffect(() => {
        if (isEditMode && id) {
            fetchWorkshop();
        }
    ...
    const fetchWorkshop = async () => {
        try {
            ...
            setError(err.message || 'Error loading workshop');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.message || `Error ${isEditMode ? 'updating' : 'creating'} workshop`);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="dashboard-page-header">
                ...
                <p className="dashboard-page-subtitle">
                    {isEditMode
                        ...
                        : 'Share your knowledge and skills through an engaging workshop experience'}
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="dashboard-form">
                ...
                <div className="dashboard-form-group">
                    ...
                    <input
                        ...
                        placeholder="e.g., Mindful Meditation for Beginners"
                        value={formData.title}
                        onChange={handleChange}
                        disabled={loading}
                    />
                    <div className="dashboard-input-hint">
                        Make it clear and descriptive to attract participants
                    </div>
                </div>
                ...
                <div className="dashboard-form-row">
                    <div className="dashboard-form-group">
                        ...
                        <input
                            ...
                            disabled={loading}
                        />
                        <div className="dashboard-input-hint">Set to 0 for free workshops</div>
                    </div>
                ...
                <div className="dashboard-form-group">
                    ...
                    <input
                        ...
                        name="location"
                        className="dashboard-input"
                        placeholder="e.g., Conscious Cafe or Online via Zoom"
                ...
                <div className="dashboard-form-group">
                    ...
                    <input
                        ...
                        disabled={loading}
                    />
                    <div className="dashboard-input-hint">Add a featured image to make your workshop more appealing</div>
                </div>
                ...
                <div className="dashboard-form-actions">
                    ...
                    >
                        {loading
                            ? (isEditMode ? 'Updating Workshop...' : 'Creating Workshop...')
